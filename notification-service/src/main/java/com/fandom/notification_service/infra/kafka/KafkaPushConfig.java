...
public class KafkaPushConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PushFailedMessage> pushFailedKafkaListenerContainerFactory() {
        return KafkaConsumerSupport.jsonFactory(bootstrapServers, groupId, PushFailedMessage.class);
    }
}