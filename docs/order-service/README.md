...
| [adr/009-payment-retry-design.md](./adr/009-payment-retry-design.md) | 결제 재시도 설계 및 구현 (#268) |
| [adr/010-kafka-dlq.md](./adr/010-kafka-dlq.md) | Kafka Consumer/Outbox DLQ 처리 (#270) |
...
| 환불 미완료 복구 배치 | ✅ |
| 결제 자동 재시도 (P1) | ✅ |
| Kafka Consumer/Outbox DLQ 처리 (P1) | ✅ |
| PAYMENT_REQUESTED zombie 처리 (웹훅 미수신 + 재시도 PG 재요청 실패 orphan 포함) | ❌ |