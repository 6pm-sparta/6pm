...
--
-- 적용 방법 (로컬 docker-compose 기준):
--   docker exec -i 6pm-postgres psql -U root -d fandom_db -f - < order-service/src/main/resources/sql/manual_migrations.sql
-- 또는 psql 접속 후 currentSchema=order_db 상태에서 바로 실행.
--
